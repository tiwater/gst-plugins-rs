...
pub struct Knowledge {
    pub scripts: Vec<KnowledgeScript>,
}

#[derive(Debug, Serialize, Deserialize, Clone)]
pub struct KnowledgeScript {
    pub id: String,
}
...
pub struct Vision {
    ...
    pub enable_face_identification: bool,
    pub enable_object_detection: bool,
    pub object_detection_target_classes: Vec<String>,
}
